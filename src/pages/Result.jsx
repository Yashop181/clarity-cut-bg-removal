...
const Result = () => {
  return (
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
      ...
      <a className='px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-500 to-fuchsia-600 rounded-full hover:scale-105 transition-all duration-700 ' href="/">Download Image</a>
      </div>
    </div>
  )
}
